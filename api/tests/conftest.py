...
# racine du projet (le dossier contenant api/) pour que "import api...." fonctionne
...
from api.api.dependances import client_tmdb
...
from api.tests.faux_tmdb import FauxClientTMDB  # noqa: E402
