# api/services/notification_service.py — scan des diffusions du jour + envoi push
import logging
...
from api.models import Appareil, Episode, Notification, Saison, Serie, SuivreSerie
from api.services import catalogue_service
from api.services.tmdb_client import ClientTMDB
from api.services.visionnage_service import STATUTS_ACTIFS
