# api/api/visionnage.py — marquage vu/non-vu des épisodes et saisons
...
from api.models import Episode, Saison, Utilisateur, VisionnerEpisode
from api.schemas.visionnage import EpisodeVu, SaisonVue
